...
const Main = () => {
  ...
  const localS = localStorage.getItem("favoritosAppOff");
...
// cierra la venta modal
 ...
 return (
    ...
    <>
      ...
      <footer>
        <p>OfertApp - Version 2.1 - Hernán Luis Veyret - 2024</p> 
        <a className="ico-facebook" href="https://www.facebook.com/rockher/" target="_blank" rel="noopener noreferrer">FACEBOOK</a>
